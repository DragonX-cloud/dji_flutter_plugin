...
- (void)setStatusDrone:(FLTDrone *)drone completion:(void (^)(FlutterError *_Nullable))completion;
- (void)sendVideoStream:(FLTStream *)stream completion:(void (^)(FlutterError *_Nullable))completion;
@end
